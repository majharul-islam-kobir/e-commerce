...
function Products() {
  const products = useSelector((state) => state.product.products); // প্রোডাক্ট স্লাইস থেকে ডেটা
  ...
  return (
    <div>
      <h1 className="text-3xl mt-16 mb-8 font-bold text-center">NEW PRODUCTS</h1>
